...
--
-- Host: localhost:3306
-- Generation Time: Nov 04, 2025 at 03:20 AM
...
(8, 1.00, '2025-11-02 19:21:35', '2025-11-02 19:21:35', 'TESTE', 'ATIVO', 1, 9),
...
(14, 1.00, '2025-11-03 00:04:27', '2025-11-03 00:04:27', '', 'ATIVO', 1, 16);
...
(3, '/images/civic_lado.jpg', 2, '2025-11-02 18:15:14'),
(4, '/images/fusion_completo.jpg', 3, '2025-11-02 18:15:14'),
(6, '../../uploads/6907af3f27851_audi-rs6-4.0-v8-tfsi-mhev-avant-performance-tiptronic-wmimagem08305069556.jpg', 8, '2025-11-02 19:21:35'),
...
(14, 'uploads/6907dd50a8ac8-5396239.png', 11, '2025-11-02 22:38:08'),
(15, 'uploads/6907dd50c1171-21517.png', 11, '2025-11-02 22:38:08'),
(16, 'uploads/6907dd50d4719-208939-afinal-o-curso-de-agronomia-e-o-ideal-para-mim.jpg', 11, '2025-11-02 22:38:08'),
(17, 'uploads/6907dd50e0b13-126238~1.JPG', 11, '2025-11-02 22:38:08'),
(18, 'uploads/6907dd50ecd91-mulher-na-agricultura.jpg', 11, '2025-11-02 22:38:08'),
...
(23, '../../uploads/images.jpeg', 14, '2025-11-03 00:04:27');
...
(9, 399.00, 1, 1, 7, 1, 'Avant MHEV ', 2022),
...
--
ALTER TABLE `anuncio`
  MODIFY `anuncio_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `chassi`
--
ALTER TABLE `chassi`
  MODIFY `chassi_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `cor`
  MODIFY `cor_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `imagem`
--
ALTER TABLE `imagem`
  MODIFY `imagem_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;

--
-- AUTO_INCREMENT for table `marca`
--
ALTER TABLE `marca`
  MODIFY `marca_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `modelo`
--
ALTER TABLE `modelo`
  MODIFY `modelo_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `veiculo`
  MODIFY `veiculo_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

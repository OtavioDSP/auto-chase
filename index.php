    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        foreach ($usr as $usuario) { ?>
            <tr>
                ...
                <td>
                    <form method="post" action="src/php/global/global.php" onsubmit="return confirm('Tem certeza que deseja deletar este usuário?');" style="display:inline;">
    ...
    <table border="1" cellpadding="5" cellspacing="0">
        ...
        ?>
            <tr>
                ...
                <td>
                    <form method="post" action="src/php/global/global.php" onsubmit="return confirm('Tem certeza que deseja deletar este veículo?');" style="display:inline;">
